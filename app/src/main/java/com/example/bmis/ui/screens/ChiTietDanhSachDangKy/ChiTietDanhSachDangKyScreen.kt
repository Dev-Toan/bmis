...
@Composable
private fun PaidServicesContent(
...
@Composable
private fun InvoiceItemRow(invoice: ItemsServices, color: Color, onClick: () -> Unit = {}) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
        ...
        Spacer(modifier = Modifier.height(4.dp))
        Text(invoice.servicesName, color = Color.Black, fontWeight = FontWeight.Bold, fontSize = 15.sp)
        Spacer(modifier = Modifier.height(6.dp))
        Row(modifier = Modifier.fillMaxWidth()) {
            Text("Ngày đăng ký: ", color = Color.Gray, fontSize = 13.sp)
            Text(invoice.registrationDate, color = Color.DarkGray, fontSize = 13.sp)
        }
        Spacer(modifier = Modifier.height(2.dp))
        Row(modifier = Modifier.fillMaxWidth()) {
            Text("Ngày thanh toán: ", color = Color.Gray, fontSize = 13.sp)
            Text(invoice.paymentDate.ifEmpty { "—" }, color = Color.DarkGray, fontSize = 13.sp)
        }
        Spacer(modifier = Modifier.height(2.dp))
        Row(modifier = Modifier.fillMaxWidth()) {
            Text("Tổng tiền: ", color = Color.Gray, fontSize = 13.sp)
            Text(invoice.totalAmount, color = Color.DarkGray, fontSize = 13.sp)
        }
    }
}
...
fun PaidServicesScreenPreview() {
    BMISTheme {
        PaidServicesScreen(statusType = StatusType.SUCCESS)
    }
}
